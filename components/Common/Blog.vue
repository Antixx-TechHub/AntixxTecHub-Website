                ...
                <div class="col-lg-4 col-md-6">
                    <div class="sm-blog-card">
                        ...
                        <div class="blog-content">
                            ...
                            <h3>
                                <NuxtLink to="/single-blog">Some strategies to attract new customers</NuxtLink>
                            </h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="sm-blog-card">
                        ...
                        <div class="blog-content">
                            ...
                            <h3>
                                <NuxtLink to="/single-blog">How to make your business successful</NuxtLink>
                            </h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="sm-blog-card">
                        ...
                        <div class="blog-content">
                            ...
                            <h3>
                                <NuxtLink to="/single-blog">What are the strategies used in a digital marketing?</NuxtLink>
                            </h3>
                        </div>
                    </div>
                </div>
